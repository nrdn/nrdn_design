$(document).ready(function() {
	...
	scrollorama.animate('#menu',{ duration:600, delay:-50, property:'margin-top', start:450, end:10})
						 ...
						 // .animate('.m_item:even',{ duration:300, delay:-20, property:'margin-top', start:0, end:250})
	...
	scrollorama.animate('#one',{ duration:600, delay:600, property:'margin-top', start:350, end:0})
